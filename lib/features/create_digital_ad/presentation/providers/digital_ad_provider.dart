...
class DigitalAdNotifier extends StateNotifier<DigitalAdState> {
  ...
  DigitalAdNotifier() : super(DigitalAdState(adData: DigitalAdEntity()));

  void updateData(DigitalAdEntity newData) {
